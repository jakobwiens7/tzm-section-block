...
Build impressive and eye-catching sections with parallax effects, shape dividers, and many more tweaks using this versatile Gutenberg block.
...
* [View on GitHub](https://github.com/jakobwiens7/tzm-section-block)
...
When the full-height (100vh) option is enabled, you can specify a CSS selector (e.g., `.header`) whose height will be subtracted from the block's height. This ensures the section fits perfectly on the screen without being obstructed by fixed elements like headers.
...
1. **Enhanced Parallax Options**: Use stunning parallax backgrounds with fixed, slow, medium, and fast options.
2. **Customizable Divider Shapes**: Create impressive sections with fully customizable top and bottom dividers.
