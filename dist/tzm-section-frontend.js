...
(0,jarallax__WEBPACK_IMPORTED_MODULE_0__.jarallaxVideo)(); // Optional video extension

function initSectionParallax() {
  (0,jarallax__WEBPACK_IMPORTED_MODULE_0__.jarallax)(document.querySelectorAll('.has-parallax-fixed'), {
    speed: 0
  });
  (0,jarallax__WEBPACK_IMPORTED_MODULE_0__.jarallax)(document.querySelectorAll('.has-parallax-slow'), {
    speed: 0.15
  });
  (0,jarallax__WEBPACK_IMPORTED_MODULE_0__.jarallax)(document.querySelectorAll('.has-parallax-medium'), {
    speed: 0.4
  });
  (0,jarallax__WEBPACK_IMPORTED_MODULE_0__.jarallax)(document.querySelectorAll('.has-parallax-fast'), {
    speed: 1.2
  });
}
  ...
  if (sections && sections.length > 0) {
    sections.forEach(section => {
      ...
      if (selectorEl) {
        ...
        section.style.setProperty('--subtract-height', selectorHeight + 'px');
      }
    });
  }
}
...
/******/ })()
;
//# sourceMappingURL=tzm-section-frontend.js.map